...
const ProjectWindow = ({ appId }) => {
  ...
  return (
    <div className="h-full flex text-white relative">
      <div className="w-[200px] bg-[#282828]/80 p-[10px] flex flex-col gap-[6px] backdrop-blur-md">
        ...
        <div className="px-[10px] py-[6px] rounded-md text-[13px] flex items-center gap-2 opacity-70">
